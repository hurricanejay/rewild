...
up1 = UserPlant.create(plant_id: Plant.last.id, user_id: User.first.id)
up2 = UserPlant.create(plant_id: Plant.first.id, user_id: User.first.id)
up3 = UserPlant.create(plant_id: Plant.second.id, user_id: User.first.id)
up4 = UserPlant.create(plant_id: p6, user_id: User.first.id)
up5 = UserPlant.create(plant_id: p7, user_id: User.first.id)
up6 = UserPlant.create(plant_id: p5, user_id: u4.id)
up7 = UserPlant.create(plant_id: p3, user_id: u3.id)
up8 = UserPlant.create(plant_id: p2, user_id: u3.id)
up9 = UserPlant.create(plant_id: p3, user_id: u4.id)
